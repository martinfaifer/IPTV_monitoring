...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getStreamHistoryStatuses: function getStreamHistoryStatuses() {
      var _this2 = this;

      axios.get("settings/dashboard/streams/status-history").then(function (response) {
        _this2.chartOptions.xaxis.categories = response.data.categories;
        _this2.series = response.data.series;
      });
    },
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return Echo.channel("StreamsStoredStatuses").listen("BroadcastStoredStreamStatusesEvent", function (e) {
                  _this3.chartOptions.xaxis.categories = e.categories;
                  _this3.series = e.series;
                });
